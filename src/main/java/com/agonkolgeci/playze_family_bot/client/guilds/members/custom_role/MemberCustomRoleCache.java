package com.agonkolgeci.playze_family_bot.client.guilds.members.custom_role;
...
public class MemberCustomRoleCache extends MemberComponent implements CacheConnector {
    ...
    public MemberCustomRoleCache(@NotNull MemberCache memberCache) {
        ...
        databaseController.executeQuery("SELECT * FROM guilds_members_custom_ranks WHERE guild_id = ? AND member_id = ?", ranks -> {
            if(ranks.next()) {
