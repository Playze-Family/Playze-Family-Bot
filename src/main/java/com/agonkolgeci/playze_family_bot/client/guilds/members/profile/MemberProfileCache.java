package com.agonkolgeci.playze_family_bot.client.guilds.members.profile;
...
import com.agonkolgeci.playze_family_bot.client.guilds.members.MemberComponent;
import com.agonkolgeci.playze_family_bot.client.guilds.members.profile.level.MemberProfileLevel;
import com.agonkolgeci.playze_family_bot.client.guilds.members.profile.voice.MemberVoiceState;
import com.agonkolgeci.playze_family_bot.client.guilds.members.profile.voice.MemberVoiceTimer;
...
public class MemberProfileCache extends MemberComponent implements CacheConnector {
    ...
    public MemberProfileCache(@NotNull MemberCache memberCache) {
        ...
        databaseController.executeQuery("SELECT * FROM guilds_members_profiles WHERE guild_id = ? AND member_id = ?", profiles -> {
            if(profiles.next()) {
    ...
    public void attributeXP(@NotNull MemberProfileLevel memberProfileLevel) {
        addXP(0, memberProfileLevel.getGain() * (int) guildCache.getSettingsController().retrieveSetting(GuildSetting.GUILD_MULTIPLIER_XP_GAIN));
    ...
    public void takeXP(@NotNull MemberProfileLevel memberProfileLevel) {
        ...
        subtractXP(0, memberProfileLevel.getGain() * (int) guildCache.getSettingsController().retrieveSetting(GuildSetting.GUILD_MULTIPLIER_XP_GAIN));
    ...
    public boolean isBackgroundUnlocked() {
        ...
        @Nullable final Role customRole = guildCache.getSettingsController().retrieveSetting(GuildSetting.GUILD_MEMBERS_CUSTOM_ROLE);
