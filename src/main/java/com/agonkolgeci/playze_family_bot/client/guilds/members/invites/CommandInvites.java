package com.agonkolgeci.playze_family_bot.client.guilds.members.invites;
...
import com.agonkolgeci.playze_family_bot.client.guilds.invites.GuildInvite;
...
public class CommandInvites extends GuildComponent implements SlashCommandAdapter {
    ...
    public void onSlashCommandComplete(@NotNull SlashCommandInteractionEvent event) {
        ...
        switch (subCommandName) {
            case "view" -> {
                @NotNull final PEmbedBuilder embedBuilder = new PEmbedBuilder(guild, "Invitations de " + member.getUser().getName(), EmojiUtils.EMOJI_PAPERCLIP, Color.PINK);
                ...
                embedBuilder.addField("VRAIES invitations \uD83E\uDD2F", (IntegerUtils.formatNumberWithEmojis(memberInvitesCache.getTrues()) + " **vraies invitations**"), false);
