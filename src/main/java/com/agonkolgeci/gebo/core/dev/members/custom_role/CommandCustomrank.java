...
public class CommandCustomrank extends GuildComponent implements SlashCommandAdapter {
    ...
    public void onSlashCommandComplete(@NotNull SlashCommandInteractionEvent event) throws Exception {
        ...
        Checks.check(memberCustomRoleCache.hasPermissions(), MessageUtils.ERROR_MEMBER_DOES_NOT_HAVE_PERMISSIONS);
        Checks.check(canManageRoles(selfMember, guildCustomRole), MessageUtils.ERROR_BOT_INSUFFICIENT_PERMISSIONS);
