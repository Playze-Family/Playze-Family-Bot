...
import com.agonkolgeci.gebo.utils.common.objects.TimeUtils;
...
import com.agonkolgeci.gebo.utils.graphics.shapes.builders.elements.ProgressBarBuilder;
    ...
    public void onSlashCommandComplete(@NotNull SlashCommandInteractionEvent event) throws Exception {
        ...
        switch (subCommandName) {
            ...
            case "rewards" -> {
                ...
                @NotNull final PEmbedBuilder embedBuilder = new PEmbedBuilder(guild, "Paliers de récompenses", EmojiUtils.RIBBON, Color.CYAN);
